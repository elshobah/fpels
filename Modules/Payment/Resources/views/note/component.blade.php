<div>
    ...
    <x-modals.modal id="createOrEdit" title="Tambah Catatan Pengeluaran">
        <form>
            <x-slot name="body">
                ...
                {{-- <div class="form-group">
                    <x-inputs.select-two
                        ...
                        wiremodel="option"
                        :option="['Sarana Penunjang KBM' => 'Sarana Penunjang KBM', 'Honor' => 'Honor']"
                    />
                </div> --}}
                ...
                {{-- <div class="form-group">
                    <x-inputs.select-two
                        ...
                        wire:model.defer="name"
                        wire:model="option"
                        :options="['Sarana Penunjang KBM' => 'Sarana Penunjang KBM', 'Honor' => 'Honor']"
                    />
                </div> --}}
                {{-- ini nama asli dari awal --}}
                <div class="form-group">
                    <x-inputs.text
                        required
                        name="name"
