        ...
        <form>
            <x-slot name="body">
                ...
                {{-- <div class="form-group">
                    ...
                    @error('note_id') <span class="text-danger">{{ $message }}</span> @enderror
                </div> --}}

                {{-- Percobaan dengan isset --}}
                {{-- @if ($bill_id)
                <div class="form-group">
                    <x-inputs.select-two
                        required
    ...
    @push('scripts')
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                Livewire.hook('message.processed', (message, component) => {
                    customSelect('#note_id', {
                        allowClear: false,
                        placeholder: "",
                    }, (e) => {
                        @this.set('note_id', e.target.value);
                    });
                });
            });
        </script>
